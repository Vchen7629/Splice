...
async def raw_videos(js: JetStreamContext, msg_processed_kv: KeyValue, job_status_kv: KeyValue) -> None:
...
async def _process_msg(js: JetStreamContext, msg_processed_kv: KeyValue, job_status_kv: KeyValue, msg: Msg) -> None:
