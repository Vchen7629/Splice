...
func TestInvalidJSONDoesNotPublishDownstream(t *testing.T) {
...
func TestPartialChunkDoesNotPublishDownstream(t *testing.T) {
	js, nc := test.SetupNats(t)
...
// verify the manifest is written since ffmpeg will fail
func TestAllChunksReceivedTriggersCombine(t *testing.T) {
	outputDir := t.TempDir()
	js, nc := test.SetupNats(t)
